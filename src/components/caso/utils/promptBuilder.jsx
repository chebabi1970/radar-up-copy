...
Verifique se o valor do DARF corresponde ao cálculo acima.`);
  ...
  if (guide.codigo === '5100' || guide.codigo === '5100b') {
    extras.push(`
━━━ ATENÇÃO ESPECIAL — ENTRADAS NOS EXTRATOS ━━━
Para CADA entrada de crédito identificada nos extratos, gere um alerta solicitando comprovação de origem.
Origens aceitas: nota fiscal de venda, contrato de mútuo, aumento de capital integralizado, adiantamento de cliente, empréstimo bancário.
Qualquer entrada sem origem identificada = alerta crítico.`);
  }
